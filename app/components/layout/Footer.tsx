          ...
          <div>
            ...
            <ul className="list-none p-0 m-0">
              <li className="mb-3 flex items-center gap-2">
                ...
                <a href="https://www.facebook.com/high.school.prospect/" target="_blank" rel="noopener noreferrer" className="no-underline text-base font-medium text-hsp-gray">Facebook</a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://www.instagram.com/high.school.prospect/" target="_blank" rel="noopener noreferrer" className="no-underline text-base font-medium text-hsp-gray">Instagram</a>
              </li>
            </ul>
          </div>
        </div>
